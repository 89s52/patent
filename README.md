...
* 申请号: [201511032925.5](http://www2.soopat.com/Patent/201511032925)：一种基于对等网络的异构数据库同步方法——【点评：可追溯性】
	- 申请日：2015-12-31 	
	- 状态：审中-公开	
	- 申请人： 浙江图讯科技股份有限公司
	- 发明人： 王斌 孙建祖 来亦子
...
* 申请号：[201510955506.2](http://www.soopat.com/Patent/201510955506) 一种区块链溯源追踪方法
	- 申请日：2015-12-17	 
	- 状态：审中-公开
	- 申请人： 布比(北京)网络技术有限公司
	- 发明人： 蒋海 王璟 翟海滨 赵正涌 胡楠
	- 摘要：本发明涉及互联网上的溯源追踪方法，提供一种区块链溯源追踪方法，所述方法包括如下步骤：区块链系统收到某一待溯源追踪的区块链地址后，从当前区块开始，按照区块产生的次序遍历整个区块链；所述区块链系统根据遍历结果，构建所述待溯源追踪的区块链地址的收入生成树和支出生成树，获得该待溯源追踪的区块链地址的资产转移历史记录。该方法将有助于追踪区块链系统的非法使用行为及非法使用者，避免区块链系统成为被不法分子利用的工具，为区块链技术的更广泛应用提供基础，本发明的主要应用可用于审计功能。
...
* 申请号：[201510844146.9](http://www2.soopat.com/Patent/201510844146) 一种对象转移方法、装置及系统——【点评：本质为价值转移】
	- 申请日：2015-11-26
	- 状态：审中-实审
	- 申请人： 布比(北京)网络技术有限公司
	- 发明人： 蒋海 翟海滨 王璟 赵正涌
...
* 申请号：[201510836709.X](http://www2.soopat.com/Patent/201510836709) 一种数据转移的方法及装置
	- 申请日：2015-11-26
	- 状态：审中-实审
	- 申请人： 布比(北京)网络技术有限公司
	- 发明人： 蒋海 翟海滨 王璟 赵正涌
...
* 申请号：[201410618716.8](http://www2.soopat.com/Patent/201410618716) 基于数字货币的跨境支付清算系统和跨境支付方法
	- 申请日：2014-11-06
	- 状态：审中-实审
	- 申请人： 朱锐泷
	- 发明人： 朱锐泷
	- 摘要：一种基于数字货币和会员间的对手操作来完成支付和清算的跨境支付清算系统，该系统通过将法币转换成数字货币，以及与处于支付目标国的会员公司进行对手操作，来实现高速且低成本的跨境支付，同时利用对保证金的锁定、释放和赔付操作，来降低交易风险。使得跨境支付可迅速完成，并由此避免了因数字货币价格波动导致的额外风险，可广泛应用在国际贸易、跨境电商等领域。

* 申请号：[201410619756.4](http://www2.soopat.com/Patent/201410619756) 基于加密数字货币公开账本技术的用户公钥地址绑定、检索和校验的方法及系统
	- 申请日：2014-11-05
	- 状态：审中-实审
	- 申请人： 中国科学院合肥物质科学研究院
	- 发明人： 李晓风 赵赫 李芳 谭海波
	- 摘要：本发明公开了基于加密数字货币公开账本技术的用户公钥地址绑定、检索和校验的方法及系统，其特征是按如下步骤进行：1向所述加密数字货币网络中的用户公布验证公钥地址；2接收用户的注册账号请求，并接收其公钥地址；3利用与所述验证公钥地址对应的私钥地址向所述已注册用户的加密数字货币的公钥地址发送数量大于等于零的加密数字货币作为验证交易，设置验证交易的附加信息或脚本内容中包含用户的账号名；4接收来自所述加密数字货币网络中其他用户的查询请求，根据所述查询请求反馈所述已注册用户的公钥地址。本发明能大幅提升加密数字货币交易的可用性、便利性、安全性和可靠性，避免用户因公钥地址被他人篡改、冒充导致的经济损失。

* 申请号：[201410619289.5](http://www2.soopat.com/Patent/201410619289) 一种用于加密数字货币的公钥地址与用户账号的关联和检索方法及其系统
	- 申请日：2014-11-05
	- 状态：审中-实审
	- 申请人： 中国科学院合肥物质科学研究院
	- 发明人： 赵赫 李晓风 李芳 谭海波
	- 摘要：本发明公开了一种用于加密数字货币的公钥地址与用户账号的关联和检索方法及系统，所述方法是按如下步骤进行：1.向所述加密数字货币网络中的用户公布验证公钥地址；2.接收用户的注册账号请求，并接收其公钥地址，建立用户账号与公钥地址的对应关系；3.利用验证公钥地址对应的私钥地址向任意其他公钥地址发送数量大于等于零的加密数字货币作为验证交易，设置验证交易的附加信息或脚本内容中包含校验数据；4.接收来自所述加密数字货币网络中其他用户的查询请求，根据所述查询请求反馈所述已注册用户的公钥地址。本发明能大幅提升加密数字货币交易的可用性、便利性、安全性和可靠性，避免用户因公钥地址被他人篡改、冒充导致的经济损失。

* 申请号：[201520769991.X](http://www2.soopat.com/Patent/201520769991) 一种基于双界面IC卡的数字货币硬件钱包
	- 申请日：2014-11-05
	- 状态：有权/实用新型
	- 申请人： 深圳市招股科技有限公司
	- 发明人：  张国勇 鄢傲 向忠胜 程超
	- 摘要：本实用新型公开了一种基于双界面IC卡的数字货币硬件钱包，包括线圈、NFC接口芯片、金属触点、I/O接口、蓝牙模块、数字加密模块、微处理器CPU和USB接口，微处理器CPU分别连接NFC接口芯片、数字货币钱包存储区、数字加密模块、交易功能区、USB接口、蓝牙模块和I/O接口，NFC接口芯片还连接线圈，I/O接口还分别连接金属触点和蓝牙模块，数字加密模块分别连接交易功能区和数字货比钱包存储区另一端。本实用新型提出了一种应用于数字货币的硬件钱包方案，将蓝牙、USB接口与接触式、非接触式卡接口技术结合起来，能实现硬件钱包与手机、电脑之间通信，在钱包中采用两个独立的用户数据存储区，即数字货币钱包存储区和交易功能区，并且采用硬件加密使得更加安全可靠。

* 申请号：[201310743485.9](http://www2.soopat.com/Patent/201310743485) 人类数字币——【点评：奇葩山寨币】
	- 申请日：2014-11-05
	- 状态：审中-公开
	- 申请人： 苏州市牛勿耳关电器科技有限公司
	- 发明人： 杨贻方
	- 摘要：本发明提供了一种人类数字币，其特征在于每个人可以以自己的身份证进行注册，这样可以获得3枚人类数字币，注册时可以自愿提供更为详细的资料，系统对信息进行分类，从而吸引电子广告等其他增值服务，产生的年收益的55%按照所有持有人类币平均分配，这样采用人类自身作为数字货币生产根源，并实现流通化，可以实现细分广告收入回报社会，达到二次财富分配，繁荣文明的目的，用于广告发布，文化促进，福利产业。 

* 申请号：[201510262578.9](http://www.soopat.com/Patent/201510262578) 矿池中挖虚拟数字币的方法和装置
	- 申请日：2014-11-05
	- 状态：审中-实审
	- 申请人： 北京比特大陆科技有限公司
	- 发明人： 詹克团
...
* 申请号：[201410609085.3](http://www.soopat.com/Patent/201410609085) 一种数据保护方法
	- 申请日：2014-11-03
	- 状态：审中-公开
	- 申请人： 北京比特大陆科技有限公司
	- 发明人： 詹克团
	- 摘要：本发明公开了一种数据保护方法，此方法包括：执行N次加密操作，第i次加密操作包括使用第i加密密钥EKi通过第i算法对明文P进行加密后得到第i密文Ci；执行N次存储过程，第i次存储过程包括：确定与第i加密密钥EKi对应的第i解密密钥DKi，将第i个解密密钥DKi和除第i密文Ci之外且未存储过的密文存储于第i存储位置；从N个存储位置中选择M个存储位置，使用M个存储位置的一存储位置中的解密密钥以及加密过程中使用的各算法对除此存储位置之外的其它存储位置中的密文进行解密直至解密成功。本发明以增加加密过程的运算量以及提高存储方式的复杂程度的代价获取了数据安全性提高的效果。

* 申请号：[201510432510.0](http://www.soopat.com/Patent/201510432510) 串联供电电路、虚拟数字币挖矿机和计算机服务器
	- 申请日：2015-07-21
	- 状态：审中-实审
	- 申请人： 北京比特大陆科技有限公司
	- 发明人： 詹克团 朱翔 张金宝 程文杰 刘金锁
	- 摘要：本发明公开一种串联供电电路、虚拟数字币挖矿机和计算机服务器，涉及电源供电技术领域，其中所述串联供电电路，在供电端与地之间至少串行连接两个待供电芯片，两相邻待供电芯片之间分别串行连接一个信号电平转换单元，各待供电芯片分别连接一个辅助电源单元。本发明提供的串联供电电路，不仅可以降低设计生产成本，而且可以有效克服电源能量转化效率低的问题。

* 申请号：[201510520251.7](http://www.soopat.com/Patent/201510520251) 比特币工作量证明哈希计算芯片优化的方法、装置和电路
	- 申请日：2015-08-21
	- 状态：审中-实审
	- 申请人： 北京比特大陆科技有限公司
